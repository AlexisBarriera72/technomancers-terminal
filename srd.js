/* SRD 5.1 content, kept in its own file and its own origin.
 *
 ...
 *
 * The attribution below is required by the licence, not decoration. It is
 * rendered next to the SRD chip in the Codex.
 */
window.TTSRD = {
  meta: {
  ...
  subclasses: [
    {
      ...
      name: "Wild Magic",
      levelAvailable: 1,
      tagline: "You cast unshielded, and the city computes the overflow.",
      page: null,
      origin: "srd",
      description: [
      ...
      features: [
        {
          ...
          blocks: [
            {
              type: "p",
              text: "Starting when you choose this origin at 1st level, your spellcasting can unleash surges of untamed magic. Once per turn, the DM can have you roll a d20 immediately after you cast a sorcerer spell of 1st level or higher. If you roll a 1, roll on the Wild Magic Surge table to create a random magical effect."
            },
            {
              type: "p",
            ...
            },
            {
              ...
              rows: [
                ...
                ["05–06", "A modron chosen and controlled by the DM appears in an unoccupied space within 5 feet of you, then disappears 1 minute later. In Cathedra these arrive looking like stray maintenance units that pinged in from somewhere far more orderly than here."],
                ["07–08", "You cast fireball as a 3rd-level spell centered on yourself."],
                ["09–10", "You cast magic missile as a 5th-level spell."],
                ["11–12", "Roll a d10. Your height changes by a number of inches equal to the roll. If the roll is odd, you shrink. If the roll is even, you grow."],
                ["13–14", "You cast confusion centered on yourself."],
                ["15–16", "For the next minute, you regain 5 hit points at the start of each of your turns."],
                ["17–18", "You grow a long beard made of fibre-optic filament that remains until you sneeze, at which point the filaments explode out from your face."],
                ["19–20", "You cast grease centered on yourself."],
                ["21–22", "Creatures have disadvantage on saving throws against the next spell you cast in the next minute that involves a saving throw."],
                ["23–24", "Your skin turns the vibrant blue of a dead advertising panel. A remove curse spell can end this effect."],
        ...
        },
        {
          ...
          blocks: [
            {
              type: "p",
              text: "Starting at 1st level, you can manipulate the forces of chance and chaos to gain advantage on one attack roll, ability check, or saving throw. Once you do so, you must finish a long rest before you can use this feature again."
            },
            {
              type: "p",
              text: "Any time before you regain the use of this feature, the DM can have you roll on the Wild Magic Surge table immediately after you cast a sorcerer spell of 1st level or higher. You then regain the use of this feature."
            },
            {
              type: "p",
              text: "The trade is never stated out loud and never negotiable: you take the win now and the system takes it back later, at a moment of its choosing rather than yours."
            }
          ]
        },
        {
        ...
        },
        {
          ...
          blocks: [
            ...
            {
              type: "p",
              text: "Years of reading your own fault logs have taught you to feel a surge arriving a half second before it lands, and to lean. Two futures queue up; you pick the one you can survive."
            }
          ]
        },
        {
          ...
          blocks: [
            {
              type: "p",
              text: "Beginning at 18th level, the harmful energy of your spells intensifies. When you roll damage for a spell and roll the highest number possible on any of the dice, choose one of those dice, roll it again and add that roll to the damage. You can use this feature only once per turn."
            },
            {
              type: "p",
